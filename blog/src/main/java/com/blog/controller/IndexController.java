...
public class IndexController {
    ...
    @GetMapping("/blog/{id}")
    public String toBlog(@PathVariable Long id, Model model, HttpServletRequest request){
        //System.out.println(request.getRequestURI());
        Blog blog = blogService.getDetailedBlog(id,true);
        model.addAttribute("blog", blog);
        //System.out.println("--------------------------"+blog.getTitle()+ " times:"+ (++count) +"--------------------------");
        return "blog";
    }
