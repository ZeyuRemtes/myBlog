...
public class BlogServiceImpl implements BlogService {
    ...
    @Override
    public Blog getDetailedBlog(Long id,boolean flag) {
    ...
    public int saveBlog(Blog blog) {
        ...
        blog.setViews(0);
        if(blog.getFirstPicture()==null) blog.setFirstPicture("https://unsplash.it/800/450?image=1005");
        //保存博客
...
//        blog.setUpdateTime(new Date());
        ...
        blog.setViews(view+1); //博客的浏览数目+1

//        System.out.println("pppppppppppppppppppp-"+blog.getTitle()+" views: "+view);
